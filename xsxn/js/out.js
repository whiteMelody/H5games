...
(function(g) {
    ...
    g.init(320, 550).pushImage([{
        id: "bg1",
        src: "/games/xsxn/img/bg1.jpg"
    }, {
        id: "bg2",
        src: "/games/xsxn/img/bg2.jpg"
    }, {
        id: "s1",
        src: "/games/xsxn/img/s1.png?123"
    }]).asyncImage([{
        id: "s2",
        src: "/games/xsxn/img/s2.png"
    }, {
        id: "n1",
        src: "/games/xsxn/img/number1.png"
    }, {
        id: "n2",
        src: "/games/xsxn/img/number2.png"
    }]);
    ...
    g.pageLoad(function() {
        ...
        var B = g.canvas.screen.getDevice(),
            x = {
                ...
                screenFade: function() {
                    this.isGameOver || (this.screenFlush = [1, 0.9, 0.8, 0.7, 0.6, 0.5, 0.4, 0.3, 0.2, 0.1, 0], window.dp_submitScore2 && dp_submitScore2(g.localStorage.getItem("FlappyBirdBestScore"), x.score));
                    return this
                },
                initObses: function() {
                    this.obses = [];
