	...
	ck: function() {
		function a() {
			function a(c) {
				b.invoke(c, {
					appid: y.Lh,
					img_url: "http://web.game.zhaopian.com",
					img_width: "200",
					img_height: "200",
					link: y.url(),
					desc: y.Rc.$h(),
					...
					document.location="http://web.game.zhaopian.com";
				})
			}
...
var y = y || {};
y.Lh = "";
y.domain = "http://web.game.zhaopian.com";
y.url = function() {
	return "http://web.game.zhaopian.com?u="+ Math.floor(Math.random()*10000000);
};
y.qj = "http://web.game.zhaopian.com/mtl";
y = y || {};
y.game = "game.html";
y.Rc = {
	$h: q("今日轻游戏—今日热门《摩天楼》，等你来战！"),
	title: function() {
...
y.c.qe = x.Layer.extend({
	...
	Zi: function() {
		var a = this.Th = cc.LabelTTF.create("今日轻游戏", "Arial", 12);
	...
	ctor: function() {
		...
		function(a) {
			...
			var c = new y.c.Uc("+关注", "ma_button_blue", function() {
				location.href = "http://web.game.zhaopian.com"
			}, this);
